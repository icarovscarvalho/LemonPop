...
export function DropDown({display, handleToggleLang}:DropDownProps) {

  return(
    <div className={`${display} flex-col gap-1 absolute top-8 left-10 w-fit p-[10px] z-10 border border-gray-100 shadow-md/10 rounded-xl bg-white`}>
      {countrysList.map(cl => (
